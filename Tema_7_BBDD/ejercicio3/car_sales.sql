...
-- Tiempo de generación: 06-05-2021 a las 13:56:31
...
CREATE TABLE `deliveries` (
  ...
  `delivey_date` date DEFAULT NULL,
...
INSERT INTO `deliveries` (`delivery_id`, `sale_id`, `delivey_date`, `other_details`) VALUES
(1, 1, '2015-12-01', ''),
(2, 2, '2020-01-01', ''),
(3, 3, '2020-01-01', ''),
(4, 4, '2020-01-01', ''),
...
CREATE TABLE `ref_model_types` (
  ...
  `parent_model_type_code` varchar(150) DEFAULT NULL,
  `model_type_name` varchar(150) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
(4, 3, 4, '2020-01-01', '', 25000),
(5, 4, 5, '2020-01-01', '', 300000),
(6, 4, 6, '2015-01-01', '', 450000),
(7, 2, 7, '2015-01-01', '', 850000);
...
CREATE TABLE `vehicles` (
  ...
  `model_type_code` varchar(64) DEFAULT NULL,
...
(7, 'SS', 'Lamborghini Aventador', '2021-01-01', '');
...
--
ALTER TABLE `vehicles`
  MODIFY `vehicle_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `ref_model_types`
  ADD CONSTRAINT `ref_model_types_ibfk_1` FOREIGN KEY (`parent_model_type_code`) REFERENCES `ref_model_types` (`model_type_code`) ON DELETE CASCADE;
