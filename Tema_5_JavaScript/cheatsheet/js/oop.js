...
Car.getHp = function () {// no actualiza instancias
    // console.log("this car has 200 horsepower");
}
...
class Magazine extends Book {
    ...
    constructor(title, author, year, month) {
        ...
        super(title, author, year); // llama a los valores que tenia pevios book;
    ...
    getType() {
        super.getType();// Podemos acceder a propiedades de nuestro constructror principal book;
